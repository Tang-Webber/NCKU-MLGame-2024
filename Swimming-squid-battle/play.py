...
from ml import ml_play_model, ml_play_model2
...
if __name__ == '__main__':
    player1 = ml_play_model.MLPlay("A", {'level': LEVEL, 'level_file': LEVEL_FILE, 'game_times': GAME_TIMES, 'sound': SOUND})
    player2 = ml_play_model2.MLPlay("B", {'level': LEVEL, 'level_file': LEVEL_FILE, 'game_times': GAME_TIMES, 'sound': SOUND})
    # for i in tqdm(1501):
    with tqdm(total=1501, unit="場遊戲") as pbar:
